...
const ImageButton = styled(ButtonBase)(({ theme }) => ({
  position: "relative", // necesario para hijos absolute
  height: 200,
  flex: "1 0 30%",
  margin: theme.spacing(1),
  [theme.breakpoints.down("sm")]: {
    flex: "1 0 100%", // en mobile ocupa todo el ancho
  },
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "center" }}>
        {images.map((image) => (
          <ImageButton key={image.title} focusRipple>
